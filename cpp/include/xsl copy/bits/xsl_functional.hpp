...
namespace functional {
  ...
  inline constexpr bool is_placeholder = ts::is_same<Tp, placeholder>;
  //
  ...
  public:
    ...
    class MixSeq_impl : public ts::tp::_1<ts::nt::remove_front<ArgSeqRep, 1 + ts::is_member_func_ptr<_Callee>>> {};
    ...
    struct memfunc {};
    struct norfunc {};
    using FuncType = typename ts::conditional<ts::is_member_func_ptr<_Callee>, memfunc, norfunc>;
  public:
    ...
    // ts::nt::make_index_sequence<sizeof...(_Args)>{}, MixSeq{}, tuple(tag_store{}, forward<Unbound>(unbound)...)))
    {
      return Call(FuncType{},
        ts::nt::remove_front<ts::nt::make_index_sequence<sizeof...(_Args)>, ts::is_member_func_ptr<_Callee>>{},
...
namespace test {
  namespace binder {
    ...
    void xsl_test_binder() {
      ...
      TEST_ACT_PRINT(auto tf00 = xsl::functional::bind(&f00));
      TEST_ACT_PRINT(f00());
      TEST_ACT_PRINT(tf00());
      TEST_ACT_PRINT(auto tf11 = xsl::functional::bind_front<1>(&f01));
      TEST_ACT_PRINT(auto tf12 = xsl::functional::bind(&f01, tmp));
      TEST_ACT_PRINT(auto tf13 = xsl::functional::bind(&f01, xsl::as_const(tmp)));
      TEST_ACT_PRINT(auto tf14 = xsl::functional::bind(&f01, xsl::wrap_ref(tmp)));
      TEST_ACT_PRINT(auto tf15 = xsl::functional::bind(&f01, test_p{}));
      ...
      TEST_ACT_PRINT(tf15());
      TEST_ACT_PRINT(auto tf21 = xsl::functional::bind_front<1>(&f02));
      TEST_ACT_PRINT(auto tf22 = xsl::functional::bind(&f02, xsl::wrap_ref(tmp)));
      TEST_ACT_PRINT(auto tf23 = xsl::functional::bind(&f02, xsl::wrap_ref(tmp)));
      ...
      TEST_ACT_PRINT(tf23());
      TEST_ACT_PRINT(auto tf31 = xsl::functional::bind_front<1>(&f03));
      TEST_ACT_PRINT(auto tf32 = xsl::functional::bind(&f03, tmp));
      TEST_ACT_PRINT(auto tf33 = xsl::functional::bind(&f03, xsl::as_const(tmp)));
      TEST_ACT_PRINT(auto tf34 = xsl::functional::bind(&f03, xsl::wrap_ref(tmp)));
      TEST_ACT_PRINT(auto tf35 = xsl::functional::bind(&f03, test_p{}));
      ...
      TEST_ACT_PRINT(tf35());
      TEST_ACT_PRINT(auto tf41 = xsl::functional::bind_front<2>(&f04));
      TEST_ACT_PRINT(auto tf42 = xsl::functional::bind_front<1>(&f04, i));
      TEST_ACT_PRINT(auto tf43 = xsl::functional::bind(&f04, xsl::functional::placeholder{}, tmp));
      TEST_ACT_PRINT(auto tf44 = xsl::functional::bind(&f04, i, tmp));
      TEST_ACT_PRINT(f04(i, tmp));
      TEST_ACT_PRINT(tf41(i, tmp));
      TEST_ACT_PRINT(tf42(tmp));
      TEST_ACT_PRINT(tf43(i));
      TEST_ACT_PRINT(tf44());
      TEST_ACT_PRINT(auto tf51 = xsl::functional::bind_front<1>(&test_p::test_func00, &tmp));
      TEST_ACT_PRINT(auto tf52 = xsl::functional::bind(&test_p::test_func00, &tmp, tmp));
      TEST_ACT_PRINT(auto tf61 = xsl::functional::bind_front<1>(&test_p::test_func01, &tmp));
      TEST_ACT_PRINT(auto tf62 = xsl::functional::bind(&test_p::test_func01, &tmp, tmp));
