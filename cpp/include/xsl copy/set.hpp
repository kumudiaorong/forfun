...
#ifndef XSL_SET
#define XSL_SET
#include "bits/xsl_functor.hpp"
#include "bits/xsl_rb_tree.hpp"
...
private:
  class ek {
  public:
    constexpr const _Key& operator()(const val_type& val) { return val; }
  };
public:
  // clang-format off
	typedef ek 		  ek_type;
...
template <class _Key, class _Comp = functor::less<_Key>, class _Alloc = default_allocator<int>>
class set : public rb_tree<set_traits<_Key, _Comp, _Alloc>> {
public:
  // clang-format off
	typedef rb_tree<set_traits<_Key, _Comp, _Alloc>>        base_type;
...
*/
template <class _Key, class _Comp = functor::less<_Key>, class _Alloc = default_allocator<int>>
class multiset : public rb_tree<set_traits<_Key, _Comp, _Alloc>> {
public:
  // clang-format off
	typedef rb_tree<set_traits<_Key, _Comp, _Alloc>>		    base_type;
	typedef _Key 											                      key_type;
