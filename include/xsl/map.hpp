...
namespace xsl {
  ...
  typedef pair<const _Key, _Val>  val_type;
    ...
    private:
      class ek {
      public:
        constexpr const typename val_type::first_type& operator()(const val_type& val) {
          return val.first;
        }
      };
    public:
  ...
  template <class _Key, class _Val, class _Comp = fc::less<_Key>, class _Alloc = alc::default_allocator<_Val>>
  class map : public tree::rb<impl::map_traits<_Key, _Val, _Comp, _Alloc>> {
  public:
    // clang-format off
  typedef tree::rb<impl::map_traits<_Key, _Val, _Comp, _Alloc>>  base_type;
  ...
  //   }
  // }
  template <class _Key, class _Val, class _Comp = fc::less<_Key>, class _Alloc = alc::default_allocator<int>>
  class multimap : public tree::rb<impl::map_traits<_Key, _Val, _Comp, _Alloc>> {
  public:
    // clang-format off
  typedef tree::rb<impl::map_traits<_Key, _Val, _Comp, _Alloc>>  base_type;
  typedef _Key                                            key_type;
