...
template <class CIter, class Creator, ts::enable<!ts::is_pointer<CIter> && is_creater<ts::rm_ref<Creator>>> = 0>
...
template <class CIter, class Cond, ts::enable<!ts::is_pointer<CIter> && is_condition<ts::rm_ref<Cond>>> = 0>
